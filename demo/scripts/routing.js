...
async function videoRouting() {
    ...
    wave.innerHTML =
    `<source src="./resources/${subject}${block}${channel}/others/waveform-${subject}${block}.mp4"  type="video/mp4">
    <source src="./resources/${subject}${block}${channel}/others/waveform-${subject}${block}.webm"  type="video/webm">`
}
